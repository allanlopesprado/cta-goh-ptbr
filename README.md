...
## Quero entender a parte técnica

A documentação técnica completa (metodologia, auditorias, scripts, validações, fontes de pesquisa e governança) está em:

- [Guia Técnico Completo](docs/DEVELOPMENT.md)
